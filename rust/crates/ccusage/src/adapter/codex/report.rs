...
use crate::{
    Align, CodexGroup, CodexModelUsage, Color, PricingMap, Result, SimpleTable, TimestampMs,
...
pub(super) fn calculate_codex_event_cost(
    ...
    let usage = CodexModelUsage {
        ...
        long_context_input_tokens: is_long_context
            .then_some(event.input_tokens)
            .unwrap_or_default(),
        long_context_cached_input_tokens: is_long_context
            .then_some(event.cached_input_tokens)
            .unwrap_or_default(),
        long_context_output_tokens: is_long_context
            .then_some(event.output_tokens)
            .unwrap_or_default(),
